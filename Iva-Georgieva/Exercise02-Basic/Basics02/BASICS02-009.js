...
let b3 = '🐒'.codePointAt(0);
let b4 = '🐗'.codePointAt(0);
let b5 = '🐧'.codePointAt(0);

console.log(b1.toString(10));
console.log(b2.toString(10));
console.log(b3.toString(10));
console.log(b4.toString(10));
console.log(b5.toString(10));
