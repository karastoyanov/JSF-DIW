...
console.log(allChar.substring(0, 1));
console.log(allChar.substring(0, 2));
console.log(allChar.substring(0, 3));
console.log(allChar.substring(0, 4));
console.log(allChar.substring(0, 5));
console.log(allChar.substring(0, 6));
console.log(allChar.substring(0, 7));
console.log(allChar.substring(0, 8));
console.log(allChar.substring(0, 9));