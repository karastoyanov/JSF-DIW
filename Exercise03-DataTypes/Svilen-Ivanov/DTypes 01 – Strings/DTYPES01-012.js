...
let sumChars = firstName.at(-1).charCodeAt(0) + middleName.at(-1).charCodeAt(0) + familyName.at(-1).charCodeAt(0);
...
console.log(`The sum of the unicode values for the first letters of my first, middle and last name is ${sumChars}.`);