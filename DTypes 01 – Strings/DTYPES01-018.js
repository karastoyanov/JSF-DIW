...
console.log(Primitive.substring(0,1));
console.log(Primitive.substring(0,2));
console.log(Primitive.substring(0,3));
console.log(Primitive.substring(0,4));
console.log(Primitive.substring(0,5));
console.log(Primitive.substring(0,6));
console.log(Primitive.substring(0,7));
console.log(Primitive.substring(0,8));
console.log(Primitive.substring(0,9));